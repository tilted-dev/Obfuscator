...
namespace ATS.Obfuscator.Utils.DnUtils
{
    public static class InjectHelper
    {
        ...
        private static void CopyTypeDef(TypeDef typeDef, InjectContext ctx)
        {
            ...
            foreach (var inter in typeDef.Interfaces)
                newTypeDef.Interfaces.Add(new InterfaceImplUser(ctx.Importer.Import(inter.Interface)));
        }
        ...
        private static void CopyMethodDef(MethodDef methodDef, InjectContext ctx)
        {
            ...
            if (methodDef.ImplMap != null)
                newMethodDef.ImplMap =
                    new ImplMapUser(new ModuleRefUser(ctx.TargetModule, methodDef.ImplMap.Module.Name), methodDef.ImplMap.Name, methodDef.ImplMap.Attributes);
